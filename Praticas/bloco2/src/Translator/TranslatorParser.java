...
public class TranslatorParser extends Parser {
	...
	public static final int
		T__0=1, Word=2, Num=3, NEWLINE=4, WS=5, COMMENT=6;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, null, "Word", "Num", "NEWLINE", "WS", "COMMENT"
		};
	}
	...
	public static class StatContext extends ParserRuleContext {
		public TerminalNode Num() { return getToken(TranslatorParser.Num, 0); }
		public TerminalNode Word() { return getToken(TranslatorParser.Word, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof TranslatorListener ) ((TranslatorListener)listener).enterStat(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof TranslatorListener ) ((TranslatorListener)listener).exitStat(this);
		}
	}
